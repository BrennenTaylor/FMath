...
namespace Farlor
{
    ...
    public:
        Matrix4x4() noexcept;
        Matrix4x4(const Vector4& row1, const Vector4& row2, const Vector4& row3, const Vector4& row4) noexcept;
        Matrix4x4(const Quaternion& q, const Vector3& pos) noexcept;
        ...
        static Matrix4x4 TranslationMatrix(const Vector3& translation) noexcept;
        static Matrix4x4 RotationMatrix(const Quaternion& rotation) noexcept;
        static Matrix4x4 RotationYawPitchRollMatrix(const Vector3& yawPitchRoll);
        static Matrix4x4 ScaleMatrix(const Vector3& scale) noexcept;
