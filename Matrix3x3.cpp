...
namespace Farlor {
Matrix3x3 Matrix3x3::s_Identity
...
Matrix3x3 &Matrix3x3::Matrix3x3::operator*=(const Matrix3x3 &rhs) noexcept
{
    ...
    m_rows[1] = Vector3(m_r1c0 * rhs.m_r0c0 + m_r1c1 * rhs.m_r1c0 + m_r1c2 * rhs.m_r2c0,
          m_r1c0 * rhs.m_r0c1 + m_r1c1 * rhs.m_r1c1 + m_r1c2 * rhs.m_r2c1,
          m_r1c0 * rhs.m_r0c2 + m_r1c1 * rhs.m_r1c2 + m_r1c2 * rhs.m_r2c2);
    m_rows[2] = Vector3(m_r2c0 * rhs.m_r0c0 + m_r2c1 * rhs.m_r1c0 + m_r2c2 * rhs.m_r2c0,
...
bool Matrix3x3::operator!=(const Matrix3x3 &other) const noexcept { return !(*this == other); }
...
Matrix3x3 Matrix3x3::operator*(float &rhs) const noexcept { return Matrix3x3(*this) *= rhs; }
